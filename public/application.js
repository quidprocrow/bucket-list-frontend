...
var mainTemplate = __webpack_require__(17);
var signUpTemplate = __webpack_require__(34);
var signInTemplate = __webpack_require__(35);
var profileTemplate = __webpack_require__(36);
var changePassTemplate = __webpack_require__(37);
var createItemTemplate = __webpack_require__(9);
...
var onSignUpLoad = function onSignUpLoad() {
  var signUpHTML = signUpTemplate();
  $('#form').html(signUpHTML);
};

var onSignInLoad = function onSignInLoad() {
  var signInHTML = signInTemplate();
  $('#form').html(signInHTML);
};

var onChangePassLoad = function onChangePassLoad() {
  onClearState();
  var changePassHTML = changePassTemplate();
  $('#changePassContainer').html(changePassHTML);
};

var onProfileLoad = function onProfileLoad() {
  var profileHTML = profileTemplate();
  $('#content').html(profileHTML);
};

var onCreateItemLoad = function onCreateItemLoad() {
  onClearState();
  var createItemHTML = createItemTemplate();
...
var config = {
  apiOrigins: {
    ...
    production: 'https://serene-eyrie-46099.herokuapp.com'
  }
};
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<section>\n        <h1>Create Item</h1>\n        <div>\n          <form id=\"createItemForm\">\n            <div>\n                  <input name=\"item[title]\" type=\"text\" placeholder=\"TITLE\">\n                  </div>\n                  <div>\n                  <input name=\"item[description]\" type=\"text\" placeholder=\"DESCRIPTION\">\n                  </div>\n                  <button>CREATE</button>\n              </form>\n            </div>\n        </section>\n";
},"useData":true});
...
var fillers = __webpack_require__(4);

var updateItemTemplate = __webpack_require__(44);

var onCreateItemSubmit = function onCreateItemSubmit(event) {
  event.preventDefault();
  fillers.onClearState();
  var data = getFormFields(event.target);
  api.createItem(data).then(onIndexItems).then(ui.onCreateItemSuccess).catch(ui.onCreateItemFailure);
};

var onIndexItems = function onIndexItems() {
  fillers.onClearState();
  api.indexItems().then(ui.onIndexItemsSuccess).catch(ui.onIndexItemsFailure);
};

var onUpdateItemSubmit = function onUpdateItemSubmit(event) {
  event.preventDefault();
  fillers.onClearState();
  var data = getFormFields(event.target);
  api.updateItem(data).then(onIndexItems).catch(ui.onUpdateItemFailure);
};

var onDeleteItemClick = function onDeleteItemClick() {
  fillers.onClearState();
  var dataId = $(this).parents('.card').data('id');
  api.deleteItem(dataId).then(onIndexItems).catch(ui.onDeleteItemFailure);
};

var onUpdateItemClick = function onUpdateItemClick() {
  fillers.onClearState();
  var dataId = $(this).parents('.card').data('id');
  var parent = $(this).parents('.card');
  var title = parent.find('.card-title').text();
  var description = parent.find('.card-description').text();
  var item = {
    _id: dataId,
    title: title,
    description: description
  };
  var updateItemHTML = updateItemTemplate({ item: item });
  $(this).parents('.card-body').html(updateItemHTML);
};

var userEventListeners = function userEventListeners() {
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<section>\n  <h1>SIGN UP</h1>\n      <div>\n        <form id=\"signUpForm\">\n          <div class=\"center\">\n              <input name=\"credentials[email]\" type=\"text\" placeholder=\"USERNAME\" class=\"input-field\">\n              </div>\n            <div class=\"center\">\n              <input name=\"credentials[password]\" type=\"password\" placeholder=\"PASSWORD\" class=\"input-field\">\n              </div>\n            <div class=\"center\">\n              <input name=\"credentials[password_confirmation]\" type=\"password\" placeholder=\"PASSWORD CONFIRMATION\" class=\"input-field\">\n              </div>\n              <button>SIGN UP</button>\n          </form>\n          <div id=\"errorMessageSignUp\">\n            </div>\n        </div>\n        </section>\n";
},"useData":true});
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<section>\n        <h1>SIGN IN</h1>\n        <div>\n          <form id=\"signInForm\">\n            <div>\n                  <input name=\"credentials[email]\" type=\"text\" placeholder=\"USERNAME\">\n                  </div>\n                  <div>\n                  <input name=\"credentials[password]\" type=\"password\" placeholder=\"PASSWORD\">\n                  </div>\n                  <button>SIGN IN</button>\n              </form>\n              <div id=\"errorMessageSignIn\">\n                </div>\n            </div>\n        </section>\n";
},"useData":true});
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<h1> Profile </h1>\n<button id=\"changePass\">Change Password</button>\n<button id=\"signOut\">Sign Out</button>\n<button id=\"createItem\">Create Item</button>\n<div id=\"errorMessageProfile\"></div>\n<div id=\"changePassContainer\"></div>\n<div id=\"createItemContainer\"></div>\n<div id=\"bucketListBucket\"></div>\n";
},"useData":true});
...
var itemEvents = __webpack_require__(11);
var fillers = __webpack_require__(4);
// const store = require('../store')

var onSignInSubmit = function onSignInSubmit(event) {
  event.preventDefault();
  fillers.onClearState();
  var data = getFormFields(event.target);
  api.signInUser(data).then(ui.onSignInSuccess).then(itemEvents.onIndexItems).catch(ui.onSignInFailure);
};
...
var onSignUpSubmit = function onSignUpSubmit(event) {
  ...
  api.signUpUser(data).then(ui.onSignUpSuccess).catch(ui.onSignUpFailure);
};

var onChangePassSubmit = function onChangePassSubmit(event) {
  event.preventDefault();
  fillers.onClearState();
  var data = getFormFields(event.target);
  api.changePassUser(data).then(ui.onChangePassSuccess).catch(ui.onChangePassFailure);
};

var onSignOutClick = function onSignOutClick() {
  fillers.onClearState();
  api.signOutUser().then(ui.onSignOutSuccess).catch(ui.onSignOutFailure);
};
...
var signInUser = function signInUser(data) {
  return $.ajax({
...
var changePassUser = function changePassUser(data) {
  return $.ajax({
...
var passwordMissMatch = function passwordMissMatch() {
...
// const store = require('../store')
var indexItemsTemplate = __webpack_require__(43);
var createItemTemplate = __webpack_require__(9);

var onCreateItemSuccess = function onCreateItemSuccess(data) {
  $('#createItemContainer').html('');
};

var onCreateItemFailure = function onCreateItemFailure() {
  $('#errorMessageProfile').text('You failed...');
};

var onIndexItemsSuccess = function onIndexItemsSuccess(data) {
...
var onIndexItemsFailure = function onIndexItemsFailure() {
  var buttonHTML = '\n    <p>\'Unable to display Bucket-Items</p>\n    <button id="indexItemsFailButton">TRY AGAIN</button>';
  $('#errorMessageProfile').html(buttonHTML);
};

var onUpdateItemFailure = function onUpdateItemFailure() {
  $('#errorMessageProfile').text('You failed...to update item');
};

var onDeleteItemFailure = function onDeleteItemFailure() {
  $('#errorMessageProfile').text('Unable to delete Bucket Item');
};

module.exports = {
  onCreateItemSuccess: onCreateItemSuccess,
  onCreateItemFailure: onCreateItemFailure,
  onIndexItemsSuccess: onIndexItemsSuccess,
  onIndexItemsFailure: onIndexItemsFailure,
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "    <div class=\"card\" data-id=\""
    ...
    + "</h3>\n          <button class=\"btn btn-warning\" id=\"updateItemButton\">Edit</button>\n          <button class=\"btn btn-danger\" id=\"deletItemButton\">Delete</button>\n      </div>\n    </div>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "<div id=\"cardsDisplay\">\n"
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<form class=\"updateItemForm\">\n  <input type=\"hidden\" name=\"item[id]\" value=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.item : depth0)) != null ? stack1._id : stack1), depth0))
    + "\" />\n  <h1 class=\"card-title\"><input type=\"text\" name=\"item[title]\" value=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.item : depth0)) != null ? stack1.title : stack1), depth0))
    + "\" /></h1>\n  <h3 class=\"card-description\"><input type=\"text\" name=\"item[description]\" value=\""
